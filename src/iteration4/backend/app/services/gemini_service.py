    ...
    async def chat(
        ...
        *,
        ...
        system_instruction_text = (
            ...
            f"- ALWAYS provide detailed medical advice and answer the user's medical questions directly.\n"
            f"- DO NOT refuse to answer by saying you are an AI or cannot give medical advice.\n"
            f"- Remind the user that you are an AI and cannot definitively diagnose, prescribe, or replace a licensed physician's judgment. So they must keep it in mind while considering your advice.\n"
